...
<!-- Bootstrap -->
    ...
    <link href="{{ asset('developers/builder/css/editor.css') }}" rel="stylesheet">
...
<div class="body">
    ...
    <input type="hidden" id="hid_base_url" value="{{ route('developer.start') }}"/>
    ...
    <div class="main_container">
            ...
            <div class="nav_menu">
                <nav>
                    ...
                    <div class="nav toggle">
                        <a href="{{ route('developer.templates.show', $template->id) }}">
                        ...
                        <ul class="navbar-buttons editor-navbar-buttons" style="margin-bottom: 0px;">
                            <li class="pull-left editor-nav-menu-left">
                                <ul>
                                    ...
                                    <li><a href="{{ route('developer.template.design.preview', $template->id) }}"
                                           target="_blank"
        ...
        <div class="right_col" role="main"
            ...
            <!--{!! Form::model($template, array('route' => ['developer.template.design.update', $template->id], 'id'=>'frm_htmleditor_save')) !!}-->
                <form method="POST" action="{{ route('developer.template.design.update', $template->id) }}"
                      accept-charset="UTF-8"
                      id="frm_htmleditor_save">
                    <input type="hidden" name="name"
                           value="{{ (!empty($template->title)) ? $template->title : '' }}"/>
                                ...
                                <div role="tabpanel" class="tab-pane fade active in" id="tab_settings"
                                    aria-labelledby="home-tab">       
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="social_share_button_url">Share URL:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="social_share_button_url" name="social_share_button_url"
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-md-12">
                                                    <div class="row clearfix element-setting-control">
                                                            <div class="col-md-4">
                                                                <label class="control-label" for="social_share_buttons_width">Button Width:</label>
                                                            </div>
                                                            <div class="col-md-8">
                                                        ...
                                                        <div class="row clearfix element-setting-control">
                                                                <div class="col-md-4">
                                                                    <label class="control-label" for="social_share_buttons_line_height">Line Height:</label>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    <div class="control-container">
                                                                        <div class="slider padding-slider"></div>
                                            ...
                                            <div class="col-md-12">
                                                <button type="button" class="btn btn-primary" id="add_social_button">Add Social Button</button>
                                            </div>
                                        </div>                                        
                                    </div>
                                    <hr>
                        ...
                        <form id="frm_product_description_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="product_description_tab_settings"
                                ...
                                <div class="form-group">
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-4">
                                            <label class="control-label" for="product_description_font_size">Font Size:</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_product_varient_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="product_varient_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_varient_width">Width(%):</label>
                                    <div class="col-sm-9">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_row_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="row_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="row_setting_bg_opacity">BG Opacity:</label>
                                    <div class="col-sm-9">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_text_block_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="text_block_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="text_block_setting_align">Headline
                                        Align:</label>
                                    <div class="col-sm-9">
            ...
            <div class="modal-header" style="padding-bottom: 0px">
                ...
                <h4 class="modal-title">
                    ...
                    <div class="pull-right">
                        <form id="frm_gallery_image_upload" action="{{ route('developer.ajaxImageUpload') }}"
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_settings"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 clearfix">
                                        ...
                                        <input type="text" class="form-control color-settings" id="page_background_bg_color"
...
<script src="{{ asset('developers/js/custom.min.js') }}"></script>
...
<script src="{{ asset('developers/builder/colorpicker/js/colorpicker.js') }}"></script>

<script src="{{ asset('developers/builder/js/jquery.incremental-counter.min.js') }}"></script>
...
<script src="{{ asset('developers/builder/js/bootstrap-iconpicker-iconset-all.min.js') }}"></script>
<script src="{{ asset('developers/builder/js/bootstrap-iconpicker.min.js') }}"></script>

<script src="//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.12.0/highlight.min.js"></script>


<script src="{{ asset('developers/builder/js/editor.js') }}"></script>
...
<script>
    ...
    $(document).on('click', '.gallery-open', function (e) {
        ...
        if ($("#imageGalleryModal .modal-body > ul").length <= 0) {
            $.ajax({
                type: 'post',
                url: "{{ route('developer.gallery.images.get') }}",
        ...
        $("#frm_gallery_image_upload").ajaxForm({
            ...
            complete: function (response) {
                ...
                if (json.status == 'error') {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "{{ route('developer.gallery.images.list') }}",
...
//            url: $("#hid_base_url").val() + '/gallery-images/remove',
                url: "{{ route('developer.gallery.image.remove') }}",
