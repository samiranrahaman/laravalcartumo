                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6 col-md-offset-3 template-desc">
                                        ...
                                        <ul class="template-info">
                                            <li>Category: <strong>{{ $data['pageTemplate']->getCategory($data['pageTemplate']->type)->name }}</strong></li>
                                            <li>Last Update: <small>{{ date('d m, Y', strtotime($data['pageTemplate']->updated_at)) }}</small></li>
                                        </ul>
                                        <img src="{{ $data['pageTemplate']->image }}" />
                                        <div class="desc">
                                            <ul>
                                                <li><a href="{{ route('developer.template.design', $data['pageTemplate']->id) }}" target="_blank" class="btn special-button-success">Design template</a></li>
                                                <li><button type="button" class="btn special-button-primary btn-block" data-toggle="modal"
                                                    data-target="#updateTemplateModal"><i class="fa fa-pencil" aria-hidden="true"></i></button></li>
                                                <li><button type="button" id="button_clear_content" class="btn special-button-warning" title="Clear Content" data-action="{{ route('developer.template.clear', $data['pageTemplate']->id) }}"><i class="fa fa-refresh" aria-hidden="true"></i></button></li>
                                                <li><button type="button" id="button_remove_template" class="btn special-button-danger" title="Remove template" data-action="{{ route('developer.templates.destroy', $data['pageTemplate']->id) }}"><i class="fa fa-trash-o" aria-hidden="true"></i></button></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab1" class="nav nav-tabs bar_tabs right" role="tablist">
                                            ...
                                            <li role="presentation" class=""><a href="#tab_payment_type" role="tab"
                                                                                ...
                                                                                aria-expanded="false"><i class="fa fa-usd" aria-hidden="true"></i> Payment Type</a>
                                            </li>
                                        </ul>
