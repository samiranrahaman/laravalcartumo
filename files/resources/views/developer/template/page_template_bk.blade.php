    ...
    <div class="main_container">
                        ...
                        <ul class="navbar-buttons editor-navbar-buttons" style="margin-bottom: 0px;">
                            <li class="pull-left editor-nav-menu-left">
                                <ul>
                                    ...
                                    <li><a href="{{ route('developer.template.design.preview', $template->id) }}" target="_blank"
        ...
        <div class="right_col" role="main"
            ...
            <!--{!! Form::model($template, array('route' => ['developer.template.design.update', $template->id], 'id'=>'frm_htmleditor_save')) !!}-->
                <form method="POST" action="{{ route('developer.template.design.update', $template->id) }}" accept-charset="UTF-8"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group gallery-open" data-toggle="modal"
                                            ...
                                            <span class="input-group-addon remove-image-path" id="image_setting_remove_image_path"><i
                                                        class="fa fa-trash-o"
                                                        alt="Remove Image"
                                                        title="Remove Image"
                                                        aria-hidden="true"></i></span>
