            ...
            <div class="col-sm-6 col-md-6 col-md-offset-3 signin-form">
                ...
                @endif
	                ...
	                <?php if ( !empty( $_GET['code'] ) ) { ?>
                        <h2 class="promo-highlight"><span>Lifetime</span> exclusive promo with a 7 day <span>free</span> trial</h2>
                    <?php } ?>
                ...
                <div class="account-wall">
                    ...
                    <form class="form-signin" method="POST" action="{{ route('register') }}">
						...
						<?php } else { ?>
						<!--<input type="hidden" name="register_special_code" value="{{ env('REGISTER_CODE_LIFETIME_PROMO') }}">-->
						<input type="hidden" name="register_special_code" value="{{ env('REGISTER_CODE_LIFETIME_PROMO') }}">
                        <?php }?>
