            ...
            <div class="container">
                <div class="row middle-row">
                    <div class="col-xs-12 col-md-5">
                        ...
                        <a href="{{ route('site.plans.get') }}" class="bttn-5">Get Started for 14 days TRIAL</a>
                ...
                <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3 text-center">
                    <div class="page-title">
                        ...
                        <p>Cartumo offers drag & drop funnel building.
                            ...
                            Don't believe us? Try our 14-day free trial & find out for yourself.</p>
                    </div>
                    <div class="space-80"></div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="price-box blue wow animated" style="visibility: visible;">
                        ...
                        <a href="{{ route('register', 'type=monthly') }}" class="bttn-3">Start My 14 days
                            Trial</a>
                    </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="price-box blue wow animated" style="visibility: visible;">
                        ...
                        <a href="{{ route('register', 'type=yearly') }}" class="bttn-3">Start My 14 days
                            Trial</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-4">
