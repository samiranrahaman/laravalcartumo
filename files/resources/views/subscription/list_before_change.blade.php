                    ...
                    <div class="register-box clearfix">
                        <div class="col-xs-12 col-md-7 left-side">
                            <div class="header-text-info text-center">
                                ...
                                <p class="chanable-text">14-days free, then <span>$67 per month</span><p>
                            </div>
                                    ...
                                    <div class="row radio-row">
                                        <div class="radio">
                                            <label clas="control-label">
                                                <input type="radio" name="subscription_plan" value="monthly" data-change-text="$67 per month" checked required /> Monthly plan ($67/month)
                                            </label>
                                        </div>

                                        <div class="radio">
                                            <label clas="control-label">
                                                <input type="radio" name="subscription_plan" value="yearly" data-change-text="$697 per year" <?php ((!empty(Auth::user()->subscription('main'))) && (Auth::user()->subscription('main')->stripe_plan == 'yearly')) ? 'checked' : '';  ?> required /> Annual plan ($697/year - Save $147)
                                            </label>
                                        </div>
                                    </div>
