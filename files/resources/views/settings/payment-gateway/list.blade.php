                ...
                <div class="col-md-8">
                    ...
                    <div class="page-title">
                        <div class="title_left" style="margin-bottom: 15px;">
                            <h3 class="dashboard-page-title"><i class="fa fa-shopping-cart"></i> Manage Payment Gateways
                            </h3>
                            <a class="btn special-button-primary btn-lg" href="{{ route('payment-gateway.create') }}"
                                            ...
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td class="integration-details">
                                                        <span><img src="{{ asset('images/' . $gateway->type . '.png') }}"
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <span>
                                                            <button class="btn btn-danger btn-remove-payment-details"
                                                                    data-gateway-id="{{ $gateway->id }}"><i
                                                                        class="fa fa-trash"
