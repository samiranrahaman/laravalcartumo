    ...
    <div class="right_col" role="main">
        ...
        <div class="page-title">
            <div class="title_left">
                <h2 class="dashboard-page-title"><i class="fa fa-life-ring"></i> New Coupon</h2>
            </div>
        </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-9">
                <div class="x_panel">
                    <div class="x_content">
                        {!! Form::open(array('route' => 'coupon.store', 'data-parsley-required' => '', 'class' => 'form-horizontal form-label-left input_mask')) !!}
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                                    ...
                                    {{ Form::number('discount', NULL, array('class' => 'form-control has-feedback-right', 'required' => '', 'maxlength' => 255, 'placeholder' => 'Enter the percentage amount')) }}
                                    <span class="fa fa-percent form-control-feedback right" aria-hidden="true"></span>
                                </div>
                            </div>

                            <div class="row clearfix">
                                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback xdisplay_inputx">
                ...
                <!--<div class="x_panel">
                    <div class="x_content">
                        <div class="image text-center">
                            <img src="{{ asset('global/img/no-user.jpg') }}" style="width: 100%"/>
                        </div>
                    </div>
                </div>-->
            </div>
