...
@section ('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">
                Edit user
                <small>edit developer details</small>
            </h1>
            <ol class="breadcrumb">
                <li>
                    <i class="fa fa-dashboard"></i>  <a href="{{ route('admin.developer.index') }}">Dashboard</a>
                </li>
                <li>
                    <i class="fa fa-dashboard"></i>  <a href="{{ route('admin.developer.index') }}">Developer</a>
                </li>
                <li class="active">
                    <i class="fa fa-file"></i> Edit Developer
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6 form-user">
                    ...
                    {!! Form::model($data['developer'], array('route' => ['admin.developer.update', $data['developer']->id], 'method' => 'PUT', 'data-parsley-required' => '')) !!}
                        {{ csrf_field() }}
                        <fieldset>
