                                            ...
                                            <div class="all-messenger-users">
                                                @if ( count($chatUsers) > 0 )
                                                    @foreach ( $chatUsers as $chatUser )
                                                        ...
                                                        <div class="items" data-message-id="{{ $chatUser['id'] }}" data-user-id="{{ $chatUser['user_id'] }}">
                                                            <ul>
                                                                <li>
                                                                    @if ( $chatUser['is_ip'] )
                                    ...
                                    <div class="col-md-8">
                                        <div class="messenger-messages">
                                            ...
                                            <div class="all-messenger-messages">
                                                <div class="items"><p class="blank_chat_info">Select a user from left to view the conversations</p></div>
                                            </div>

                                            <div class="messenger-messages-footer">
                                                <textarea class="form-control" placeholder="Type message here..." id="messenger_message_text"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.messenger-users .all-messenger-users > .items', function(e) {
            ...
            $.ajax({
                ...
                url: $("#hid_base_url").val() + "/user/" + $(this).attr('data-user-id') + "/messages/" + $(this).attr('data-message-id'),
