<div class="ld-element ld-element-form paypal-payment-form-wrapper inline-element" id="{{ $id }}"
    ...
    <div class="element-payment-form lh4 ld-margin0 element-text-shadow">
        <div class="wrapper">
            ...
            <div class="payment-form-panel">
                ...
                <div class="panels">
                    <div class="form-group">
                        <label for="selection_payment_card">
                            <input type="radio" id="selection_payment_card" name="payment_selection"
                                   class="panel-selection-radio"
                        ...
                        <div class="form-group">
                            <div class="row clearfix">
                                <div class="col-md-8 col-sm-8 col-xs-12 div-grid">
                                    ...
                                    <input type="text" class="form-control" data-stripe="number" id="number"
                                           placeholder="Card Number"/>
                                </div>

                                <div class="col-md-4 col-sm-4 col-xs-12 div-grid">
                                    <label for="ccv">CVC:</label>
                                    <input type="text" class="form-control" data-stripe="cvc" id="cvc"
                                           placeholder="CVC"/>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panels paypal-panel">
                    <div class="form-group">

                        <label for="selection_payment_paypal">
                            <input type="radio" id="selection_payment_paypal" name="payment_selection"
                                   class="panel-selection-radio"
                                   value="paypal" required/>
                            <img src="{{ asset('images/paypalac1.png') }}" style="width: 19%"/>
                        </label>
                    </div>

                    <div class="body" style="display: none;">
                        <img src="{{ asset('images/redirect.png') }}"/>
                        <p>After clicking "<span>Complete Order</span>", you will be redirect to PayPal to complete your
                            purchase securely.</p>
                    </div>
                </div>
