    ...
    <div class="ld-element empty-space-wrapper ld-editable inline-element" id="{{ $id }}" data-de-type="headline">
        <div class="element-empty-space lh4 size3 ld-margin0 element-text-shadow">
            <div class="empty-space-wrapper wrapper">
        ...
        <div class="ld_inline_controls">
            <ul class="ld_option_menu">
                ...
                <li class="ld_controls_edit open-spacebar-setings-modal" data-toggle="modal"
                    data-target="#spaceBarSettingsModal"><i class="fa fa-cog" aria-hidden="true"></i></li>
