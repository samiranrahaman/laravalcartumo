            ...
            <div class="wrapper">
                <div class="step-parts step-section">
                    <div class="step-caption">
                        <span><strong data-step-enabled="true">Step #2</strong></span> <span>Shipping Information</span>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row clearfix">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="apt" class="form-control" placeholder="Apt, suit, etc."/>
                            </div>
                        </div>
                    </div>
