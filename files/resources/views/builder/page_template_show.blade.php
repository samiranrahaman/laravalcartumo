...
<body class="nav-sm landing-page-editor" id="page_view_body">
...
<script>
    ...
    if ($(".element-product-varients").find('.option-item') != null) {
        ...
        $(document).on("change", ".element-product-varients .option-item select, .element-product-quantity select", function (e) {
            ...
            //alert(title);
            var element_href = $(".element-button").attr("href");

            $(".element-button").removeAttr('href');
            $(".element-button").css("opcatity", "0.50");
            //alert(this);
            ...
            $.ajax({
                ...
                complete: function() {
                    $(".element-button").attr('href', element_href);
                    $(".element-button").css("opcatity", "1");
                },
                error: function (a, b) {
