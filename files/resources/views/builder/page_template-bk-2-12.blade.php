    ...
    <div class="main_container">
        ...
        <div class="top_nav">
            <div class="nav_menu">
                <nav>
                        ...
                        <div class="logo">
                            <a class="navbar-brand" href="#page-top"><img src="{{ asset('images/logo1.png') }}" style="width:124px" /></a>
                        </div>
                    ...
                    <div class="pull-left" style="padding: 15px; width: 74%">
                        <ul class="navbar-buttons" style="margin-bottom: 0px;">
                            ...
                            <li><a href="{{ route('page.view', $page->slug) }}" target="_blank" class="btn btn-primary"
                                   id="button_editor_preview"> <i class="fa fa-eye" aria-hidden="true"></i> Preview </a>
                            </li>

                            <!--<li>
                                <button class="btn btn-info-small change-screen-resolution" id="button_view_as_desktop" title="Desktop View">
                                    <i class="fa fa-desktop" aria-hidden="true"></i>
                                </button>

                                <button class="btn btn-info-small change-screen-resolution" id="button_view_as_mobile" title="Mobile View">
                                    <i class="fa fa-mobile" aria-hidden="true"></i>
                                </button>

                                <button class="btn btn-info-small change-screen-resolution" id="button_view_as_tablet" title="Tablet View">
                                    ...
                                    <li style="display: inline-flex">
                                        ...
                                        <div class="dropdown">
                                            <button class="btn btn-success dropdown-toggle" type="button"
                                                    data-toggle="dropdown" id="open_the_popup_options"><i class="fa fa-external-link"></i> &nbsp; Popup
                                            </button>
                                            <ul class="dropdown-menu">
                                                <li><a href="javascript:void(0)" class="show-tracking-modal" id="show_the_popup" data-popup-open="popup-1">
                                                    <i class="fa fa-eye"></i> Show Popup</a>
                                                </li>
                                                <li><a href="javascript:void(0)" class="show-popup-modal open-page-popup-setings-modal" id="popup_settings" data-toggle="modal"
        ...
        <div class="right_col" role="main"
            ...
            <div id="editor_panel">
                ...
                <div id="htmleditor">
                    <form id="frm_htmleditor_container" class="validate-form frm_htmleditor_container" action="{{ $action }}" method="post"
                              data-parsley-validate="">
                    @if ( !empty($contents->htmlbody) )
                        <?php echo $contents->htmlbody ?>
                    @else
                            <input type="hidden" id="frm_csrf_token" name="frm_csrf_token"
                                   value="{{ csrf_token() }}"/>
                            <input type="hidden" id="frm_hid_user_id" name="frm_hid_user_id"
                                   value="{{ Auth::user()->id }}"/>
                            ...
                            <div class="editor-container element-type-main clearfix text-center">
                                <div class="lb-content-body" id="main-html-container">
                                    <button style="margin-top: 30px; width: 70%"
                                            class='add-inner-element btn btn-primary add-element add-first-element-on-editor' data-section-id='row'
                    ...
                    <!-- MODAL POPUP -->
                            <div class="popup" data-popup="popup-1" id="data_page_popup" style="background-color:rgba(0,0,0,0.75)">
                                <div class="popup-inner" data-modal-width="medium" style="background-color:#FFFFFF;color:#000000;padding-top:40px;padding-right:0px;padding-bottom:40px;padding-left:0px;margin-top:0px;margin-right:0px;margin-bottom:0px;margin-left:0px;">
                                    <div class="body">
                                        <div class="ld-element ld-grid-container ld_content element element-type-grid container-element" data-de-type="grid">
                                            <div class="lb-content-body clearfix" style="padding-left:15px;padding-right:15px;padding-top:40px;padding-bottom:40px">
                                                <div class="col-md-12 sub-parent">
                                                    <div class="g-container">
                                                        <button class='add-inner-element btn btn-primary add-element' data-section-id='element' id='element_modal' alt='Add elements' data-toggle='modal' data-target='#elementModal'>ADD ELEMENT</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <button class="btn btn-transparent add-element add-grid content-add-element" data-section-id="grid" id="grid_modal" alt="Add elements"
                                                    data-toggle="modal" data-target="#gridModal">
                                                <i class="fa fa-plus"></i>
                                            </button>

                                            <!-- controls -->
                                            <div class="ld_controls grid_ld_controls">
                                                <ul class="ld_option_menu">
                                                    ...
                                                    <li class="ld_controls_edit grid-one-setings-modal" data-toggle="modal" data-target="#gridOneSettingsModal">
            ...
            <!--<form id="frm_htmleditor_save" action="{{ route('pages.update', $page->id) }}" method="put">-->
                ...
                <input type="hidden" name="external_fonts" id="external_fonts" value="{{ (!empty($contents->external_fonts)) ? $contents->external_fonts : ''  }}" />
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <form id="frm_icon_text_settings" class="form-horizontal">
                        <div id="myTabContent" class="tab-content">
                            <div role="tabpanel" class="tab-pane fade active in" id="icon_text_tab_icon_text"
                                 ...
                                 <div class="form-group clearfix">
                                        ...
                                        <div class="col-sm-9 text-right">
                                            <button id="icon-picker-button" type="button" class="btn btn-default btn-lg" data-icon="fa-check" data-iconset="fontawesome" role="iconpicker">
                                                ss
                                            </button>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="icon_text_tab_settings" aria-labelledby="home-tab">
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="icon_text_font_weight">Font Weight:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="icon_text_text_align" id="icon_text_text_align" class="form-control">
                                ...
                                <div class="form-group">
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-4">
                                            <label class="control-label" for="icon_text_line_height">Line Height:</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                        ...
                        <form id="frm_page_popup_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_page_popup_settings"
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="page_popup_modal_width">Modal Width:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="page_popup_modal_open_after">Modal Open After:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="modal-setting-section-header modal-setting-section-box">
                                        ...
                                        <div class="border-realted_properties">
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="page_popup_backdrop">Backdrop:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control color-settings" id="page_popup_backdrop"
                                                        name="page_popup_backdrop" placeholder="Enter background color" value=""/>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="page_popup_bg_color">BG Color:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control color-settings" id="page_popup_bg_color"
                                                        name="page_popup_bg_color" placeholder="Enter background color" value=""/>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="page_popup_text_color">Text Color:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control color-settings" id="page_popup_text_color"
                                                        name="page_popup_text_color" placeholder="Enter background color" value=""/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-setting-section-header modal-setting-section-box">
                                        ...
                                        <div class="border-realted_properties">
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="page_popup_border_style">Style:</label>
                                                <div class="col-sm-9">
                                                    <select name="page_popup_border_style" id="page_popup_border_style" class="form-control">
                                                        <option value="">None</option>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="page_popup_border_size">Size:</label>
                                                <div class="col-sm-9">
                                                    <select name="page_popup_border_size" id="page_popup_border_size" class="form-control">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="page_popup_border_color">Color:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control color-settings" id="page_popup_border_color"
                                                    name="page_popup_border_color" placeholder="Enter border color" value=""/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="tab_page_popup_advance" aria-labelledby="home-tab">
                                <div class="form-group clearfix">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="page_popup_padding_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="page_popup_padding_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="page_popup_padding_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="page_popup_margin_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="page_popup_margin_bottom" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="page_popup_margin_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="page_popup_margin_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form id="frm_select_box_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_select_box_settings"
                                 aria-labelledby="home-tab">
                                    ...
                                    <div class="row clearfix element-option-table-setting-control" id="custom_option_select" style="display:none">

                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="select_box_custom_type_name">Custom Type Name:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="select_box_custom_type_name"
                                                    name="select_box_custom_type_name" placeholder="Custom Type Name" value="" style="width:100%" />
                                            </div>
                                        </div>
                                        ...
                                        <table>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="2"><button type="button" class="btn button_add_modal_setting_options">Add New Option</button></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="tab_select_box_advance" aria-labelledby="home-tab">
                                <div class="form-group clearfix">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="select_box_padding_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="select_box_padding_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="select_box_padding_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="select_box_margin_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="select_box_margin_bottom" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="select_box_margin_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="select_box_margin_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_text_field_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_text_field_settings"
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-sm-3" for="text_field_input_type">Input Type:</label>
                                    <div class="col-sm-9">
                                        ...
                                        <select id="text_field_input_type" id="text_field_input_type" class="form-control" name="text_field_input_type"><option value="not-set">Not Set</option><option value="name">Full Name</option><option value="first_name">First Name</option><option value="last_name">Last Name</option><option value="email">Email Address</option><option value="phone">Phone Number</option><option value="address">Address</option><option value="city">City</option><option value="state">State</option><option value="country">Country</option><option value="zip">Zip</option><option value="shipping_address">Shipping Address</option><option value="shipping_city">Shipping City</option><option value="shipping_state">Shipping State</option><option value="shipping_country">Shipping Country</option><option value="shipping_zip">Shipping Zip</option><option value="vat_number">VAT Number</option></select>
                                    </div>
                                </div>


                                <div class="form-group">
                                        <label class="control-label col-sm-3" for="text_field_placeholder_text">Placeholder Text:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="text_field_placeholder_text"
                                                name="text_field_placeholder_text" placeholder="Enter text color" value=""/>
                                        </div>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="tab_text_field_advance" aria-labelledby="home-tab">
                                <div class="form-group clearfix">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="text_field_padding_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="text_field_padding_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="text_field_padding_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="text_field_margin_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="text_field_margin_bottom" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="text_field_margin_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="text_field_margin_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="order_two_step_settings_body">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="headlineTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#tab_order_two_step_settings" id="order_two_step-settings-tab" role="tab" data-toggle="tab"
                               aria-expanded="true">Settings</a>
                        </li>

                        <li role="presentation">
                            <a href="#tab_order_two_step_advance" id="order_two_step-advance-tab" role="tab" data-toggle="tab"
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_order_two_step_setting" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_order_two_step_settings"
                                 ...
                                 <div class="form-group">
                                        <label class="control-label col-sm-3" for="order_two_step_headline">Headiline:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="order_two_step_left_title">Left Tab Title:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="order_two_step_right_title">Right Tab Title:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="order_two_step_left_info">Left Tab Info:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="order_two_step_right_info">Right Tab Info:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="order_two_step_button_color">Button Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="order_two_step_button_color"
                                                name="order_two_step_button_color" placeholder="Enter Button color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="order_two_step_button_bg_color">Button BG Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="order_two_step_button_bg_color"
                                                name="order_two_step_button_bg_color" placeholder="Enter Button BG color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="order_two_step_headline_color">Headline Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="order_two_step_headline_color"
                                                name="order_two_step_headline_color" placeholder="Enter Line color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="order_two_step_headline_bg_color">Headline BG Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="order_two_step_headline_bg_color"
                                                name="order_two_step_headline_bg_color" placeholder="Enter BG color" value=""/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-3">
                                            <label class="control-label" for="order_two_step_headline_font_size">Headline Font Size:</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                                                <input type="text" name="order_two_step_headline_font_size" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-3">
                                            <label class="control-label" for="order_two_step_header_font_size">Header Font Size:</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                                                <input type="text" name="order_two_step_header_font_size" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-3">
                                            <label class="control-label" for="order_two_step_info_font_size">Info Font Size:</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                                                <input type="text" name="order_two_step_info_font_size" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>
                            </div>

                            <div role="tabpanel" class="tab-pane fade" id="tab_order_two_step_advance" aria-labelledby="home-tab">
                                <div class="form-group clearfix">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="order_two_step_padding_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="order_two_step_padding_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="order_two_step_padding_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="order_two_step_margin_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="order_two_step_margin_bottom" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="order_two_step_margin_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="order_two_step_margin_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="single_image_settings_body">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="headlineTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#tab_specebar_settings" id="image-specebar-settings-tab" role="tab" data-toggle="tab"
                               aria-expanded="true">Settings</a>
                        </li>
                    </ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="single_image_settings_body">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="headlineTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#tab_seperator_text_settings" id="image-seperator-text-settings-tab" role="tab" data-toggle="tab"
                               aria-expanded="true">Settings</a>
                        </li>
                        <li role="presentation" class="">
                            <a href="#tab_seperator_text_advance" role="tab" id="image-seperator-text-advance" data-toggle="tab"
                               aria-expanded="false">Advance</a>
                        </li>
                    </ul>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_seperator_text_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_seperator_text_settings"
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-sm-3" for="seperator_text_settings_text">Text:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                        <label class="control-label col-sm-3" for="seperator_text_settings_text_color">Text Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="seperator_text_settings_text_color"
                                                name="seperator_text_settings_text_color" placeholder="Enter text color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="seperator_text_settings_line_color">Line Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="seperator_text_settings_line_color"
                                                name="seperator_text_settings_line_color" placeholder="Enter Line color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="seperator_text_settings_bg_color">Text Bg Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="seperator_text_settings_bg_color"
                                                name="seperator_text_settings_bg_color" placeholder="Enter background color" value=""/>
                                        </div>
                                    </div>

                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-3">
                                            <label class="control-label" for="seperator_text_settings_font_size">Items Font Size:</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                                                <input type="text" name="seperator_text_settings_font_size" class="form-control"/>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="seperator_text_settings_font_weight">Font Weight:</label>
                                        <div class="col-sm-9">
                                            <select name="seperator_text_settings_font_weight" id="seperator_text_settings_font_weight"
                                                    class="form-control">
                                                <option value="">Choose</option>
                                                <?php for ( $i=100; $i<=900; $i+=100 ) { ?>
                                                    <option value="{{ $i }}">{{ $i }}</option>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="tab_seperator_text_advance" aria-labelledby="home-tab">
                                <div class="form-group clearfix">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="seperator_text_settings_padding_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            <div class="col-md-4">
                                                <label class="control-label" for="seperator_text_settings_padding_bottom">Padding
                                                    Bottom:</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="control-container">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="seperator_text_settings_padding_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="seperator_text_settings_padding_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="seperator_text_settings_margin_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            <div class="col-md-4">
                                                <label class="control-label" for="seperator_text_settings_margin_bottom">Margin
                                                    Bottom:</label>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="seperator_text_settings_margin_bottom" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="seperator_text_settings_margin_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="seperator_text_settings_margin_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="single_image_settings_body">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="headlineTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#tab_image_inside_tab_settings" id="image-inside-tab-settings-tab" role="tab" data-toggle="tab"
                               aria-expanded="true">Settings</a>
                        </li>
                        <li role="presentation" class="">
                            <a href="#tab_image_inside_tab_advance" role="tab" id="image-inside-tab-advance" data-toggle="tab"
                               aria-expanded="false">Advance</a>
                        </li>
                    </ul>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_image_inside_tab_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_image_inside_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="image_inside_tab_image_path">TAB Image:</label>
                                    <div class="col-sm-9">
                                        <div class="input-group gallery-open" data-toggle="modal"
                                             data-target="#imageGalleryModal">
                                            <input type="text" class="form-control" placeholder="Image path"
                                                   id="image_inside_tab_image_path" name="image_inside_tab_image_path" aria-describedby="basic-addon2"
                                                   value=""/>
                                            <span class="input-group-addon" id="basic-addon2"><i
                                                        class="fa fa-picture-o"
                                                        aria-hidden="true"></i></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group gallery-open" data-toggle="modal"
                                             data-target="#imageGalleryModal">
                                            <input type="text" class="form-control" placeholder="Image path"
                                                   id="image_inside_inner_image_path" name="image_inside_inner_image_path" aria-describedby="basic-addon2"
                                                   value=""/>
                                            <span class="input-group-addon" id="basic-addon2"><i
                                                        class="fa fa-picture-o"
                                                        aria-hidden="true"></i></span>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="tab_image_inside_tab_advance" aria-labelledby="home-tab">
                                <div class="form-group clearfix">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="image_inside_padding_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="image_inside_padding_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="image_inside_padding_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="image_inside_margin_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="image_inside_margin_bottom" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="image_inside_margin_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="image_inside_margin_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-body" id="empty_container_settings_body">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="gOneTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#empty_container_tab_settings" id="empty_container-settings-tab" role="tab" data-toggle="tab"
                               aria-expanded="true">Settings</a>
                        </li>
                        <li role="presentation" class="">
                            <a href="#empty_container_tab_advance" role="tab" id="empty_container-advance-tab" data-toggle="tab"
                               aria-expanded="false">Advance</a>
                        </li>
                    </ul>
                        ...
                        <form id="frm_empty_container_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="empty_container_tab_settings"
                                aria-labelledby="home-tab">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="empty_container_section_id">Section ID:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="empty_container_section_id"
                                                name="empty_container_section_id" placeholder="Enter section ID" value=""/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="empty_container_text_color">Text Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="empty_container_text_color"
                                                name="empty_container_text_color" placeholder="Enter text color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="empty_container_bg_color">Background Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="empty_container_bg_color"
                                                name="empty_container_bg_color" placeholder="Enter background color" value=""/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="empty_container_text_align">Text Align:</label>
                                        <div class="col-sm-9">
                                            <select name="empty_container_text_align" id="empty_container_text_align" class="form-control">
                                                <option value="">None</option>
                                                <option value="left">Left</option>
                                                <option value="center">Center</option>
                                                <option value="right">Right</option>
                                    ...
                                    <div class="modal-setting-section-header modal-setting-section-box">
                                        ...
                                        <div class="border-realted_properties">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="empty_container_border_style" id="empty_container_border_style" class="form-control">
                                                        <option value="">None</option>
                                                        <option value="solid">Solid</option>
                                                        <option value="dashed">Dashed</option>
                                                        <option value="dotted">Dotted</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="empty_container_border_size" id="empty_container_border_size" class="form-control">
                                                        <option value="1px">1px</option>
                                                        <option value="2px">2px</option>
                                                        <option value="3px">3px</option>
                                                        <option value="5px">5px</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control color-settings" id="empty_container_border_color"
                                                    name="empty_container_border_color" placeholder="Enter border color" value=""/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="empty_container_tab_advance" aria-labelledby="home-tab">
                                <div class="row clearfix element-setting-control">
                                    <div class="col-md-4">
                                ...
                                <div class="row clearfix element-setting-control">
                                    ...
                                    <div class="col-md-8">
                                        <div class="control-container">
                                            <div class="slider padding-slider"></div>
                                            <input type="text" name="empty_container_padding_bottom" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix element-setting-control">
                                    ...
                                    <div class="col-md-8">
                                        <div class="control-container">
                                            <div class="slider padding-slider"></div>
                                            <input type="text" name="empty_container_padding_right" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix element-setting-control">
                                    ...
                                    <div class="col-md-8">
                                        <div class="control-container">
                                            <div class="slider padding-slider"></div>
                                            <input type="text" name="empty_container_padding_left" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix element-setting-control">
                                    ...
                                    <div class="col-md-8">
                                        <div class="control-container">
                                            <div class="slider margin-slider"></div>
                                            <input type="text" name="empty_container_margin_bottom" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_faq_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="faq_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="faq_question_color">Question Color:</label>
                                    <div class="col-sm-9">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_product_add_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="product_add_tab_product"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_product">Choose product:</label>
                                    <div class="col-sm-9">
                                        <select class="form-control" id="product_add_product" name="product_add_product">
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="product_add_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_header_text">Header Text:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_bg_color">Header Bg Color:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_text_color">Header Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="product_add_text_color"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_recomonded_text">Recomomded Text:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="product_add_recomonded_text"
                                               name="product_add_recomonded_text" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_regular_price">Regular Price:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="product_add_regular_price"
                                               name="product_add_regular_price" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_instant_saving">Instant Saving:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="product_add_instant_saving"
                                               name="product_add_instant_saving" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_saving_color">Saving Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="product_add_saving_color"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_short_info">Short Info:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_info_with_price">Info with price:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="product_add_info_with_price"
                                               name="product_add_info_with_price" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_button_text">Button Text:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_button_bg_color">Button Bg Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="product_add_button_bg_color"
                                               name="product_add_button_bg_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_add_button_text_color">Button Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="product_add_button_text_color"
                                               name="product_add_button_text_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_menu_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="menu_tab_items"
                                ...
                                <div class="menu_add_container">
                                    ...
                                    <div class="panels">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="menu_settings_title">Menu Title:</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="menu_settings_link">Menu Link:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="image_text_setting_align">Menu Target:</label>
                                                <div class="col-sm-9">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="menu_settings_items"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="menu_item_bg_color">Menu BG Color:</label>
                                    <div class="col-sm-9">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_image_text_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="image_text_settings"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="image_text_headline_text"
                                               name="image_text_headline_text" placeholder="Enter headline text" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="image_text_sub_headline_text">Sub Headline Text:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="image_text_sub_headline_text"
                                               name="image_text_sub_headline_text" placeholder="Enter Sub headline Text" value=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="image_text_setting_align">Alignment:</label>
                                    <div class="col-sm-9">
                                        <select name="image_text_setting_align" id="image_text_setting_align"
                                                class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group gallery-open" data-toggle="modal"
                                             data-target="#imageGalleryModal">
                                            <input type="text" class="form-control" placeholder="Image path"
                                                   id="image_text_image_path" name="image_text_image_path" aria-describedby="basic-addon2"
                                                   value=""/>
                                            <span class="input-group-addon" id="basic-addon2"><i
                                                        class="fa fa-picture-o"
                                                        aria-hidden="true"></i></span>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="image_text_headline_text_color">Headline Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="image_text_headline_text_color"
                                               name="image_text_headline_text_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="image_text_sub_headline_text_color">Sub Headline Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="image_text_sub_headline_text_color"
                                               name="image_text_sub_headline_text_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>


                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="image_text_bg_color">Background Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="image_text_bg_color"
                                               name="image_text_bg_color" placeholder="Enter background color" value=""/>
                                    </div>
                                </div>

                                <div class="row clearfix element-setting-control">
                                    <div class="col-md-3">
                                        <label class="control-label" for="image_text_headline_font_size">Headline Font Size:</label>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="control-container">
                                            <div class="slider padding-slider"></div>
                                            <input type="text" name="image_text_headline_font_size" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix element-setting-control">
                                    <div class="col-md-3">
                                        <label class="control-label" for="image_text_sub_headline_font_size">Sub headline Font Size:</label>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="control-container">
                                            <div class="slider padding-slider"></div>
                                            <input type="text" name="image_text_sub_headline_font_size" class="form-control"/>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_testimonial_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="sub_testimonial_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="testimonial_customer_name_text">Customer Name:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="testimonial_customer_name_text"
                                               name="testimonial_customer_name_text" placeholder="Enter testimonial text" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="testimonial_customer_place_text">Customer Place:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="testimonial_customer_place_text"
                                               name="testimonial_customer_place_text" placeholder="Enter testimonial text" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="testimonial_customer_rating">Customer Rating:</label>
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" id="testimonial_customer_rating"
                                               name="testimonial_customer_rating" placeholder="Enter testimonial text" value=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="testimonial_text_setting_align" id="testimonial_text_setting_align"
                                                class="form-control">
                                            <option value="">Left</option>
                                            <option value="center"> Center</option>
                                            <option value="right"> Right</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group gallery-open" data-toggle="modal"
                                             data-target="#imageGalleryModal">
                                            <input type="text" class="form-control" placeholder="Image path"
                                                   id="testimonial_image_path" name="testimonial_image_path" aria-describedby="basic-addon2"
                                                   value=""/>
                                            <span class="input-group-addon" id="basic-addon2"><i
                                                        class="fa fa-picture-o"
                                                        aria-hidden="true"></i></span>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="testimonial_text_color">Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="testimonial_text_color"
                                               name="testimonial_text_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="testimonial_customer_name_color">Customer Name Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="testimonial_customer_name_color"
                                               name="testimonial_customer_name_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="testimonial_rating_color">Rating Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="testimonial_rating_color"
                                               name="testimonial_rating_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="testimonial_bg_color">Background Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="testimonial_bg_color"
                                               name="testimonial_bg_color" placeholder="Enter background color" value=""/>
                                    </div>
                                </div>
            ...
            <div class="modal-body" id="coupon_system_body">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="couponSystemSettingTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#coupon_system_tab_settings" id="coupon-system-settings-tab" role="tab" data-toggle="tab"
                               aria-expanded="true">Settings</a>
                        </li>
                        <li role="presentation" class="">
                            <a href="#coupon_system_tab_advance" role="tab" id="coupon-system-advance-tab" data-toggle="tab"
                               aria-expanded="false">Advance</a>
                        </li>
                    </ul>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_coupon_system_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="coupon_system_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="coupon_system_headline_text">Headline Text:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="coupon_system_headline_alignment" id="coupon_system_headline_alignment"
                                                class="form-control">
                                            <option value="left"> Left</option>
                                            <option value="center">Center</option>
                                            <option value="right"> Right</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="coupon_system_button_text">Button Text:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="coupon_system_text_color">Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="coupon_system_text_color"
                                               name="coupon_system_text_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="coupon_system_bg_color">Text BG Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="coupon_system_bg_color"
                                               name="coupon_system_bg_color" placeholder="Enter background color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="coupon_system_button_text_color">Button Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="coupon_system_button_text_color"
                                               name="coupon_system_button_text_color" placeholder="Button text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="coupon_system_button_bg">Button BG Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="coupon_system_button_bg"
            ...
            <div class="modal-body" id="headline_settings_body">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="shippingMethodSettingTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#shipping_method_tab_settings" id="shipping-method-settings-tab" role="tab" data-toggle="tab"
                               aria-expanded="true">Settings</a>
                        </li>
                        <li role="presentation" class="">
                            <a href="#shipping_method_tab_advance" role="tab" id="shipping-method-advance-tab" data-toggle="tab"
                               aria-expanded="false">Advance</a>
                        </li>
                    </ul>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_shipping_method_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="shipping_method_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="shipping_method_headline_text">Headline Text:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="shipping_method_headline_alignment" id="shipping_method_headline_alignment"
                                                class="form-control">
                                            <option value="left"> Left</option>
                                            <option value="center">Center</option>
                                            <option value="right"> Right</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="shipping_method_text_color">Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="shipping_method_text_color"
                                               name="shipping_method_text_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="shipping_method_bg_color">Background Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="shipping_method_bg_color"
                                               name="shipping_method_bg_color" placeholder="Enter background color" value=""/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="contact_form_settings"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input class="form-control" type="text" id="step_number" name="step_number" placeholder="Step #1"
                                               value=""/>
                                    </div>
                                </div>
                        ...
                        <form id="frm_order_bump_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="order_bump_tab_settings"
                                ...
                                <div class="row form-group">
                                    <label class="control-label col-sm-3" for="order_bump_headline">Bump Headline:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row form-group">
                                    <label class="control-label col-sm-3" for="order_bump_oto_headline">OTO Headline:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row clearfix element-setting-control">
                                    <div class="col-md-3">
                                        <label class="control-label" for="order_bump_headline_font_size">Headline Font Size:</label>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="control-container">
                                            <div class="slider padding-slider"></div>
                                ...
                                <div class="row clearfix element-setting-control">
                                    <div class="col-md-3">
                                        <label class="control-label" for="order_bump_text_font_size">Text Font Size:</label>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="control-container">
                                            <div class="slider padding-slider"></div>
                                ...
                                <div class="row form-group">
                                    <label class="control-label col-sm-3" for="order_bump_headline_color">Headline Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="order_bump_headline_color"
                                ...
                                <div class="row form-group">
                                    <label class="control-label col-sm-3" for="order_bump_text_color">Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="order_bump_text_color"
                                ...
                                <div class="row form-group">
                                    <label class="control-label col-sm-3" for="order_bump_headline_bg">Headline BG:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="order_bump_headline_bg"
                                ...
                                <div class="row form-group">
                                    <label class="control-label col-sm-3" for="order_bump_background">Background:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="order_bump_background"
                        ...
                        <form id="frm_product_description_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="product_description_tab_settings"
                                ...
                                <div class="form-group">
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-4">
                                            <label class="control-label" for="product_description_line_height">Line Height:</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_product_quantity_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="product_quantity_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="product_quantity_align_option">Width:</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="product_quantity_width" id="product_quantity_width"
                        ...
                        <form id="frm_product_varient_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="product_varient_tab_settings"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="product_varient_width" id="product_varient_width"
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <form id="frm_image_list_settings" class="form-horizontal">
                        <div id="myTabContent" class="tab-content">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group gallery-open" data-toggle="modal"
                                             data-target="#imageGalleryModal">
                                            <input type="text" class="form-control" placeholder="Image path"
                                                   id="image_list_image_path" name="path" aria-describedby="basic-addon2"
                                                   value=""/>
                                            <span class="input-group-addon" id="basic-addon2"><i
                                                        class="fa fa-picture-o"
                                                        aria-hidden="true"></i></span>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="image_list_tab_settings" aria-labelledby="home-tab">
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="image_list_font_weight">Font Weight:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="image_list_image_size">Image Size:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-4">
                                            <label class="control-label" for="image_list_image_text_gap">Image Text Gap:</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                                ...
                                <div class="form-group">
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-4">
                                            <label class="control-label" for="image_list_line_height">Line Height:</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="image_list_text_color">Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="image_list_text_color"
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <form id="frm_icon_list_settings" class="form-horizontal">
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="icon_list_tab_settings" aria-labelledby="home-tab">
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="icon_list_font_weight">Font Weight:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-4">
                                            <label class="control-label" for="icon_list_line_height">Line Height:</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                                    ...
                                    <div class="modal-setting-section-header modal-setting-section-box">
                                        ...
                                        <div class="border-realted_properties">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="embaded_video_border_style" id="embaded_video_border_style" class="form-control">
                                                        <option value="">None</option>
                                                        <option value="solid">Solid</option>
                                                        <option value="dashed">Dashed</option>
                                                        <option value="dotted">Dotted</option>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="embaded_video_border_size">Size:</label>
                                                <div class="col-sm-9">
                                                    <select name="embaded_video_border_size" id="embaded_video_border_size" class="form-control">
                                                        <option value="1px">1px</option>
                                                        <option value="2px">2px</option>
                                                        <option value="3px">3px</option>
                                                        <option value="5px">5px</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control color-settings" id="embaded_video_border_color"
                                                    name="embaded_video_border_color" placeholder="Enter border color" value=""/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form id="frm_seperator_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="seperator_tab_settings"
                                ...
                                <div class="modal-setting-section-header modal-setting-section-box">
                                        ...
                                        <div class="border-realted_properties">
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="seperator_border_style">Style:</label>
                                                <div class="col-sm-9">
                                                    <select name="seperator_border_style" id="seperator_border_style" class="form-control">
                                                        <option value="">None</option>
                                                        <option value="solid">Solid</option>
                                                        <option value="dashed">Dashed</option>
                                                        <option value="dotted">Dotted</option>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="seperator_border_size">Size:</label>
                                                <div class="col-sm-9">
                                                    <select name="seperator_border_size" id="seperator_border_size" class="form-control">
                                                        <option value="1px">1px</option>
                                                        <option value="2px">2px</option>
                                                        <option value="3px">3px</option>
                                                        <option value="5px">5px</option>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="seperator_border_color">Color:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control color-settings" id="seperator_border_color"
                                                    name="seperator_border_color" placeholder="Enter border color" value=""/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="paragraph_tab_themes"
                                ...
                                <div class="form-group clearfix">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                                <div class="col-md-4">
                                                    <label class="control-label" for="paragraph_shadow_size">Shadow Size:</label>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="control-container">
                                                        <div class="slider margin-slider"></div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_sub_headline_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="sub_headline_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="sub_headline_text">Headline
                                        Text:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="sub_headline_text_color">Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="sub_headline_text_color"
                                               name="sub_headline_text_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="sub_headline_bg_color">Background Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="sub_headline_bg_color"
                                               name="sub_headline_bg_color" placeholder="Enter background color" value=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-4">
                                            <label class="control-label" for="sub_headline_line_height">Line Height:</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="form-group clearfix">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row clearfix element-setting-control">
                                                <div class="col-md-4">
                                                    <label class="control-label" for="sub_headline_shadow_size">Shadow Size:</label>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="control-container">
                                                        <div class="slider margin-slider"></div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_headline_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="headline_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="headline_text_font-family">Font Family:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row clearfix">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="main_headline_bg_color"
                                               name="main_headline_bg_color" placeholder="Enter background color" value=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group clearfix">
                                    <div class="form-group clearfix">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row clearfix element-setting-control">
                                                <div class="col-md-4">
                                                    <label class="control-label" for="headline_shadow_size">Shadow Size:</label>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="control-container">
                                                        <div class="slider margin-slider"></div>
                        ...
                        <form id="grid_one_row_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="gone_tab_settings"
                                aria-labelledby="home-tab">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="grid_one_setting_section_id">Section ID:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="grid_one_setting_section_id"
                                                name="grid_one_setting_section_id" placeholder="Enter section ID" value=""/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="grid_one_bg_color">Background Color:</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="grid_one_container_bg_color">Containers BG Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="grid_one_container_bg_color"
                                                name="grid_one_container_bg_color" placeholder="Enter Inner item background color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="grid_one_container_bg_opacity">Containers BG Opacity:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="grid_one_container_bg_opacity"
                                                name="grid_one_container_bg_opacity" placeholder="Enter Inner item background opacity" value=""/>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="modal-setting-section-header modal-setting-section-box">
                                        ...
                                        <div class="border-realted_properties">
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="grid_one_border_style">Style:</label>
                                                <div class="col-sm-9">
                                                    <select name="grid_one_border_style" id="grid_one_border_style" class="form-control">
                                                        <option value="">None</option>
                                                        <option value="solid">Solid</option>
                                                        <option value="dashed">Dashed</option>
                                                        <option value="dotted">Dotted</option>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="grid_one_border_size">Size:</label>
                                                <div class="col-sm-9">
                                                    <select name="grid_one_border_size" id="grid_one_border_size" class="form-control">
                                                        <option value="1px">1px</option>
                                                        <option value="2px">2px</option>
                                                        <option value="3px">3px</option>
                                                        <option value="5px">5px</option>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="grid_one_border_color">Color:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control color-settings" id="grid_one_border_color"
                                                    name="grid_one_border_color" placeholder="Enter border color" value=""/>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="control-label col-sm-3" for="grid_one_border_apply_for">Apply For:</label>
                                                <div class="col-sm-9">
                                                    <select name="grid_one_border_apply_for" id="grid_one_border_apply_for" class="form-control">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_row_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="row_tab_settings"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="row_setting_content_width">Content Width:</label>
                                    <div class="col-sm-9">
                                        <select name="row_setting_content_width" id="row_setting_content_width" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="row_setting_text_color">Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="row_setting_text_color"
                                               name="row_setting_text_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="row_setting_bg_color">Background Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="row_setting_bg_color"
                                               name="row_setting_bg_color" placeholder="Enter background color" value=""/>
                                    </div>
                                </div>
                                ...
                                <div class="clearfix">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <select class="form-control text-normal" name="row_setting_border_style"
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="row_setting_border_size" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="row_setting_border_radius" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /BORDER -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="button_settings_body">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    <div id="myTabContent" class="tab-content">
                        <form id="frm_advance_button_settings" class="form-horizontal" data-load-poduct-action="{{ route('funnel.load.product', $page->funnel_id) }}">

                            <div role="tabpanel" class="tab-pane fade active in" id="advance_button_tab_product"
                                 aria-labelledby="home-tab">
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="advance_button_add_product">Choose product:</label>
                                    <div class="col-sm-9">
                                        <select class="form-control" id="advance_button_add_product" name="advance_button_add_product">
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="advance_button_tab_settings"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="advance_button_text" name="advance_button_text"
                                               placeholder="Enter button text" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="advance_button_secondary_text">Secondery Text:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="advance_button_secondary_text" name="advance_button_secondary_text"
                                               placeholder="Enter button text" value=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="advance_button_type" id="advance_button_type" class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="advance_button_style">Button Style:</label>
                                    <div class="col-sm-9">
                                        <select name="advance_button_style" id="advance_button_style" class="form-control">
                                            <option value="">Default</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="advance_button_text_color">Text Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="advance_button_text_color"
                                               name="advance_button_text_color" placeholder="Enter text color" value=""/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="advance_button_bg_color">Background Color:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control color-settings" id="advance_button_bg_color"
                                               name="advance_button_bg_color" placeholder="Enter background color" value=""/>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="advance_buttonbutton_padding_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider padding-slider"></div>
                                                    <input type="text" name="advance_button_padding_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="advance_button_margin_top" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="advance_button_margin_left" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row clearfix element-setting-control">
                                            ...
                                            <div class="col-md-8">
                                                <div class="control-container">
                                                    <div class="slider margin-slider"></div>
                                                    <input type="text" name="advance_button_margin_right" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <form id="frm_button_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="button_tab_settings"
                                ...
                                <div class="" id="button_settings_goto_link" style="display: none">
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="button_setting_goto_link_url">URL:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="button_setting_goto_link_url" name="button_setting_goto_link_url"
                                                placeholder="Enter URL" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="button_setting_goto_link_behaviour">URL Open In:</label>
                                        <div class="col-sm-9">
                                            <select class="form-control" id="button_setting_goto_link_behaviour" name="button_setting_goto_link_behaviour">
                                ...
                                <div class="form-group" style="display: none" id="integration_data_section">
                                    <label class="control-label col-sm-3" for="integration_data_behaviour">After Process:</label>
                                    <div class="col-sm-9">
                                      <select class="form-control" id="integration_data_behaviour" name="integration_data_behaviour">
                                ...
                                <div class="form-group" style="display: none" id="button_open_section_id">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="button_section_id" name="button_section_id"
                                               placeholder="Enter section ID" value=""/>
                                    </div>
                                </div>

                                <div class="form-group" style="display: none" id="button_open_section_toggle_id">
                                    <label class="control-label col-sm-3" for="button_section_toggle_id">Section Toggle ID:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="button_section_toggle_id" name="button_section_toggle_id"
                                               placeholder="Enter section ID" value=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="simple_button_secondary_text">Secondery Text:</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="simple_button_secondary_text" name="simple_button_secondary_text"
                                               placeholder="Enter button text" value=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="button_bg_color">Background Color:</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="row clearfix element-setting-control">
                                    <div class="col-md-3">
                                        <label class="control-label" for="button_secondary_font_size">Secondary Font Size:</label>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="control-container">
                                            <div class="slider padding-slider"></div>
                        ...
                        <form id="frm_text_block_settings" class="form-horizontal">
                            <div role="tabpanel" class="tab-pane fade active in" id="text_block_tab_settings"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="control-label" for="textblock_headline_text_color">Headline Text
                                                Color:</label>
                                            <input type="text" class="form-control color-settings jscolor"
                                                   id="textblock_headline_text_color" name="textblock_headline_text_color"
                                                   placeholder="Enter text color" value=""/>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="control-label" for="textblock_headline_bg_color">Headline Bg
                                                Color:</label>
                                            <input type="text" class="form-control color-settings jscolor"
                                                   id="textblock_headline_bg_color" name="textblock_headline_bg_color"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-3" for="text_block_setting_align">Headline Align:</label>
                                    <div class="col-sm-9">
                                        <select name="text_block_setting_align" id="text_block_setting_align" class="form-control">
                                            <option value="">Center</option>
                                            <option value="left">Left</option>
                                            <option value="right">Right</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    <div class="row clearfix element-setting-control">
                                        <div class="col-md-4">
                                            <label class="control-label" for="text_block_line_height">Line Height:</label>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="control-container">
                                                <div class="slider padding-slider"></div>
                        ...
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="date_countdown_tab_settings"
                                ...
                                <form id="frm_date_countdown_settings" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="date_countdown_timer_color">Timer Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="date_countdown_timer_color"
                                                name="date_countdown_timer_color" placeholder="Enter Timer color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="date_countdown_text_color">Text Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="date_countdown_text_color"
                                                name="date_countdown_text_color" placeholder="Enter text color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="date_countdown_seperator_color">Seperator Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="date_countdown_seperator_color"
                                                name="date_countdown_seperator_color" placeholder="Enter seperator color" value=""/>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-sm-3" for="date_countdown_bg_color">BG Color:</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control color-settings" id="date_countdown_bg_color"
                                                name="date_countdown_bg_color" placeholder="Enter background color" value=""/>
                                        </div>
                                    </div>
                                </form>
        ...
        <div class="modal-content">
            <div class="modal-header" style="padding-bottom: 0px">
                            ...
                            <ul class="image-gallery-option-buttons">
                                ...
                                <li style="margin-right: 15px;" id="gallery_image_counter">
                                    ...
                                    @if ( $userImages->count() > 196 )
                                        <span style="font-size: 16px"><b style="color: #d9534f;">{{ $userImages->count() }}</b> / <b style="color: #d9534f;">{{ env('MAX_IMAGE_UPLOAD_LIMIT') }}</b></span>
                                    @elseif ( $userImages->count() > 100 )
                                        <span style="font-size: 16px"><b style="color: #eea236;">{{ $userImages->count() }}</b> / <b style="color: #d9534f;">{{ env('MAX_IMAGE_UPLOAD_LIMIT') }}</b></span>
                                    @else
                                        <span style="font-size: 16px"><b style="color: #eeeeee;">{{ $userImages->count() }}</b> / <b style="color: #d9534f;">{{ env('MAX_IMAGE_UPLOAD_LIMIT') }}</b></span>
                                    @endif
                                </li>
                                <li>
                ...
                <div class="modalFooter clearfix">
                    <a href="javascript:void(0)" data-filter="library" class="btn-imgs btn-imgs-active" style="float:left;"
                    ...
                    @foreach ( $directories as $key=>$directory )
                        ...
                        @if ( strtolower($dir[count($dir) - 1]) != 'library' )
                            <a href="javascript:void(0)" data-filter="{{ $dir[count($dir) - 1] }}" class="btn-imgs" style="float:left;"
            ...
            <div class="modal-body">
                ...
                @foreach ( $directories as $key=>$directory )
                    ...
                    <ul class="gallery-container clearfix" data-open-content="{{ $dir[count($dir) - 1] }}"
                        ...
                        <?php //echo strtolower($dir[count($dir) - 1]); ?>

                        @if ( strtolower($dir[count($dir) - 1]) != 'library' )
                            <?php foreach ( $images as $key=>$image ) { ?>

                                <?php //echo $image->getRelativepath(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 clearfix">
                                        ...
                                        <input type="text" class="form-control" id="page_background_bg_color"
                                               name="page_background_bg_color" placeholder="PX"
...
<script>
    ...
    $(document).ready(function () {
        /*$(".element-holder").sortable({
            connectWith: ".g-container",
            helper: 'clone',
            revert: 'invalid',
...
<script>
    $(document).ready(function () {
        ...
        if ( !$("#frm_htmleditor_container").hasClass('frm-new-builder-container') ) {
                //$(this).replaceWith("<div>" + $(this).html() + "</div>");
                //$(this).remove();
        }

        $("#frm_htmleditor_container > #frm_csrf_token").val("{{ csrf_token() }}");
        $("#frm_htmleditor_container > #frm_hid_funnel_id").val("{{ $page->funnel_id }}");
        $("#frm_htmleditor_container > #frm_hid_funnel_step_id").val("{{ $page->funnel_step_id }}");
        $("#frm_htmleditor_container > #frm_hid_page_id").val("{{ $page->id }}");


        if ($("#frm_htmleditor_container > #frm_hid_user_id").length != 0)
            $("#frm_htmleditor_container > #frm_hid_user_id").val("{{ Auth::user()->id }}");
        else {
            $("#frm_htmleditor_container > #frm_hid_page_id").after('<input type="hidden" id="frm_hid_user_id" name="frm_hid_user_id" value="{{ Auth::user()->id }}"/>');
        }
        ...
        $(document).on('click', '.open-product-add-setings-modal', function(e) {
                    ...
                    $.ajax({
                        type: 'get',
                        url: "{{ route('funnel.load.product', $page->funnel_id) }}",
...
@if ( !empty($data['stepProduct']) )
    @if ( $stepProduct->product_type == 'manual' )
        <script>
            $(document).ready(function () {
                $("#frm_htmleditor_container > #hid_product_id").val("{{ $data['stepProduct']->id }}");
            });
        </script>
    @else
        <script>
            $(document).ready(function () {
                $("#frm_htmleditor_container > #hid_product_id").val("{{ $data['stepProduct'] }}");
            });
        </script>
    @endif
@endif
...
<script>
    /*$( function() {
     $( ".ld-element" ).sortable({
     connectWith: ".ld-element",
     placeholder: "ld-element"
     }).disableSelection();
     } );*/
</script>
        ...
        <script>
            $(document).ready(function () {
                if ($(".product-image-wrapper").length != 0) {
                    ...
                    const step_id = $("#frm_hid_funnel_step_id").val();

                    $.ajax({
                        type: 'POST',
                        url: "{{ route('editor.replace.product') }}",
                        data: 'step_id=' + $("#frm_htmleditor_container > #frm_hid_funnel_step_id").val() + '&_token=' + $("#csrf_token").val(),
                        ...
                        success: function (response) {
                            ...
                            //image
                            $(".product-image-wrapper").replaceWith(json.image);

                            //title
                            $(".product-name-wrapper").replaceWith(json.title);

                            //description
                            $(".product-description-wrapper").replaceWith(json.description);

                            //remove previous product variant
                            //alert($("#hid_product_variant_id").length);
                            if ($("#hid_product_variant_id").length != 0) {
                                $("#hid_product_variant_id").remove();
                            }

                            //variants
                            $(".product-varients-wrapper").replaceWith(json.variants);

                            //price
                            $(".price-wrapper").replaceWith(json.price);

                            //availability
                            $(".product-availability-wrapper").replaceWith(json.availability);


                            //product id
                            if ($("#hid_product_id").length != 0) {
                                if (json.product_id.product)
                                    $("#frm_htmleditor_container > #hid_product_id").val(json.product_id.product.id);
                                else
                                    $("#frm_htmleditor_container > #hid_product_id").val(json.product_id);
                            }
            ...
            $(document).ready(function () {
                if ($(".product-cart-wrapper").length != 0) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('editor.replace.product') }}",
                        data: 'step_id=' + $("#frm_htmleditor_container > #frm_hid_funnel_step_id").val() + '&_token=' + $("#csrf_token").val() + '&type=cart',
                        beforeSubmit: function () {
                        ...
                        success: function (response) {
                            ...
                            //image
                            $(".product-cart-wrapper").replaceWith(json.cart);
